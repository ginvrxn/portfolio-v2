      ...
      <div>
        <div className=" bg-[#F5F5F5] dark:bg-[#4F7C95] w-full">
          <div className="flex flex-col h-full sticky">
            <div className="sticky top-0 flex h-[53vh] bg-[#84B1CB] dark:bg-[#4F7C95] overflow-hidden w-full">
              <motion.div
                initial={{ y: "100%" }}
                animate={{
                  y: "0%",
                ...
                className="mt-auto mx-auto max-w-[15rem] z-[1]"
              >
                <FaceIllustration />
              </motion.div>
              <motion.div
                ...
                className="absolute right-4 w-[15%] -top-[125%] px-3"
              >
                <motion.svg
                  animate={controls}
                  initial={{ y: "-100%" }}
